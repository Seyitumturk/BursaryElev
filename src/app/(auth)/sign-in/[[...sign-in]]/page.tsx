...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#d1a989] via-[#e3cbb7] to-[#a9866b] dark:from-[#5b3d2e] dark:via-[#876650] dark:to-[#a9866b] animated-gradient relative overflow-hidden px-4">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center">
        ...
        <p className="text-sm text-[#f5ede7] dark:text-[#f5ede7] text-center max-w-xs mb-6">
          Welcome back to your bursary matching platform
        </p>
